...
func inputaninformasiidentitas(){
...
func mencari_penonton_berdasarkan_kodereservasi(){
	i = 0
	j = 0
...
func mencari_penonton_berdasarkan_noidentitas(){
	i = 0
	j = 0
...
func menampilkan_semua_data_penontonVIP(){
...
func menampilkan_komposisipenonton(){
...
func mengurutkan_penonton_berdasarkanumur(){
...
func menampilkan_jumlahkursikosong(){
	vip:=0
	kanan:=0
	kiri:=0
	for i:=1 ; i<N ; i++ {
...
func main() {
	...
	for nomor >= 1 && nomor <= 8 {
		switch {
		case nomor == 1:
			inputaninformasiidentitas()
		case nomor == 2:
			mencari_penonton_berdasarkan_kodereservasi()
		case nomor == 3:
			mencari_penonton_berdasarkan_noidentitas()
		case nomor == 4:
			menampilkan_semua_data_penontonVIP()
		case nomor == 5:
			menampilkan_okupansi()
		case nomor == 6:
			menampilkan_komposisipenonton()
		case nomor == 7:
			mengurutkan_penonton_berdasarkanumur()
		case nomor == 8:
			menampilkan_jumlahkursikosong()
